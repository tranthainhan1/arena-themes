...
/*  Theme cart 4.0.0 	*/ (this.Shopify = this.Shopify || {}),
  (this.Shopify.theme = this.Shopify.theme || {}),
  (this.Shopify.theme.cart = (function (t) {
    "use strict";
    function u() {
      return JSON.parse(
        JSON.stringify({
    ...
    return (
      ...
      (t.addItem = function (t, e) {
        return (
          ...
          (i = e.properties),
          ((o = u()).method = "POST"),
          (o.body = JSON.stringify({ id: r, quantity: n, properties: i })),
          a("/cart/add.js", o)
        );
        var r, n, i, o;
      }),
      (t.addItemFromForm = function (t) {
        !(function (t) {
        ...
        var e,
          ...
          n = new FormData(t);
        return (
          c(parseInt(n.get("id"), 10)),
          (e = n),
          delete (r = u()).headers["Content-Type"],
          (r.method = "POST"),
          (r.body = e),
          a("/cart/add.js", r)
        );
      }),
      (t.updateItem = function (t, e) {
        return (
          i(t),
          o(e),
          f(t).then(function (t) {
      ...
      (t.removeItem = function (t) {
        return (
          i(t),
          f(t).then(function (t) {
            return r(t, { quantity: 0 });
          })
        );
      }),
      (t.clearItems = function () {
        return ((t = u()).method = "POST"), a("/cart/clear.js", t);
        var t;
      }),
      (t.getAttributes = s),
      (t.updateAttributes = h),
      ...
      (t.clearNote = function () {
        return n({ note: "" });
      }),
      (t.getShippingRates = function () {
        return a("/cart/shipping_rates.json", u());
      }),
      t
    );
  })({}));
/* 	Theme section 		*/ (this.Shopify = this.Shopify || {}),
  (this.Shopify.theme = this.Shopify.theme || {}),
  (this.Shopify.theme.sections = (function (t) {
    "use strict";
    ...
    function o(t, e) {
      (this.container = (function (t) {
        ...
        if (null !== t.getAttribute(n)) return t;
        throw new Error(
    ...
    function a(t, o) {
      (t = h(t)),
        void 0 === o && (o = document.querySelectorAll("[" + i + "]")),
        (o = l(o)),
          ...
          void 0 !== n &&
            (o = o.filter(function (t) {
              return (
                ...
                (t.getAttribute(i) !== e || (s.push(new n(t)), !1))
              );
            }));
        });
    }
    ...
    function p(t) {
      var n = [];
      if (NodeList.prototype.isPrototypeOf(t) || Array.isArray(t)) var e = t[0];
    ...
    return (
      window.Shopify.designMode &&
        (document.addEventListener("shopify:section:load", function (t) {
          var e = t.detail.sectionId,
            n = t.target.querySelector("[" + r + '="' + e + '"]');
          null !== n && a(n.getAttribute(i), n);
        }),
        document.addEventListener("shopify:section:unload", function (t) {
          var e = t.detail.sectionId,
            n = t.target.querySelector("[" + r + '="' + e + '"]');
          "object" == typeof p(n)[0] && f(n);
        }),
      ...
      (t.register = function (t, e) {
        ...
        return (
          ...
          (c[(n.prototype.type = t)] = n)
        );
      }),
      (t.unregister = function (t) {
        (t = h(t)).forEach(function (t) {
          delete c[t];
        });
      }),
      (t.load = a),
